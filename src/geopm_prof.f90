...
module geopm_prof
    ...
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_UNKNOWN =  1
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_COMPUTE =  2
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_MEMORY =   3
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_NETWORK =  4
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_IO =       5
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_SERIAL =   6
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_PARALLEL = 7
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_IGNORE =   8
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_INACTIVE = 9
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_SPIN =     10
