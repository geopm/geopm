...
module geopm_prof
    ...
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_MEMORY =   12884901888
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_NETWORK =  17179869184
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_IO =       21474836480
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_SERIAL =   25769803776
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_PARALLEL = 30064771072
    INTEGER(8), PARAMETER :: GEOPM_REGION_HINT_IGNORE =   34359738368
