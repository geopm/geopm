...
namespace geopm
{
    ...
    enum event_e {
        ...
        EVENT_NAME_MAP = 7,      /// EVENT: The application is shutting down and has
                                 ...
                                 ///         parameter).
        EVENT_SHORT_REGION = 8,  /// EVENT: The application entered and exited a
