...
#ifndef VARIORUMIOIMP_HPP_INCLUDE
#define VARIORUMIOIMP_HPP_INCLUDE
...
//    class MSRPath;
    ...
    class VariorumIOImp : public VariorumIO
    {
        public:
            VariorumIOImp();
            VariorumIOImp(int num_cpu, std::shared_ptr<MSRPath> path);
            virtual ~VariorumIOImp();
