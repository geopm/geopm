...
The generated test.sbatch should be modified to include the following
options, where ``MAX_UNCORE_FREQ``, ``MIN_UNCORE_FREQ``,
...
The CPU compute activity agent policy can then be generated by running::
    ...
    integration/experiment/uncore_frequency_sweep/gen_cpu_activity_policy_recommendation.py --path <UNCORE_SWEEP_DIR>
