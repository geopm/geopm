...
void LevelZeroIOGroupTest::SetUpDefaultExpectCalls()
{
    ...
    for (int sub_idx = 0; sub_idx < m_num_gpu_subdevice; ++sub_idx) {
        ...
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_RESET_COUNT_CORRECTABLE
                    ras_reset_count_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_PROGRAMMING_ERRCOUNT_CORRECTABLE
                    ras_programming_errcount_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_DRIVER_ERRCOUNT_CORRECTABLE
                    ras_driver_errcount_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_COMPUTE_ERRCOUNT_CORRECTABLE
                    ras_compute_errcount_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT_CORRECTABLE
                    ras_noncompute_errcount_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_CACHE_ERRCOUNT_CORRECTABLE
                    ras_cache_errcount_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_DISPLAY_ERRCOUNT_CORRECTABLE
                    ras_display_errcount_correctable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));

        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_RESET_COUNT_UNCORRECTABLE
                    ras_reset_count_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_PROGRAMMING_ERRCOUNT_UNCORRECTABLE
                    ras_programming_errcount_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_DRIVER_ERRCOUNT_UNCORRECTABLE
                    ras_driver_errcount_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_COMPUTE_ERRCOUNT_UNCORRECTABLE
                    ras_compute_errcount_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT_UNCORRECTABLE
                    ras_noncompute_errcount_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_CACHE_ERRCOUNT_UNCORRECTABLE
                    ras_cache_errcount_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
        EXPECT_CALL(*m_device_pool, // GPU_CORE_RAS_DISPLAY_ERRCOUNT_UNCORRECTABLE
                    ras_display_errcount_uncorrectable(GEOPM_DOMAIN_GPU_CHIP, sub_idx, MockLevelZero::M_DOMAIN_ALL));
