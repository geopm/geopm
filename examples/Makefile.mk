...
check_PROGRAMS += examples/geopm_print_error
...
if ENABLE_MPI
    check_PROGRAMS += examples/timed_region
...
if ENABLE_MPI
if ENABLE_SCHED
    check_PROGRAMS += examples/synthetic_benchmark \
                      # end
...
if ENABLE_OPENMP
if ENABLE_SCHED
    check_PROGRAMS += examples/simple_prof_c \
...
if ENABLE_FORTRAN
    check_PROGRAMS += examples/simple_prof_f
