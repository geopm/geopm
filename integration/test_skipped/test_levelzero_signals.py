...
class TestIntegrationLevelZeroSignals(unittest.TestCase):
    ...
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_RESET_COUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_PROGRAMMING_ERRCOUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_DRIVER_ERRCOUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_COMPUTE_ERRCOUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_CACHE_ERRCOUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_DISPLAY_ERRCOUNT_CORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_RESET_COUNT_UNCORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_PROGRAMMING_ERRCOUNT_UNCORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_DRIVER_ERRCOUNT_UNCORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_COMPUTE_ERRCOUNT_UNCORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT_UNCORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_CACHE_ERRCOUNT_UNCORRECTABLE gpu 0")
    @util.skip_unless_geopmread("LEVELZERO::GPU_CORE_RAS_DISPLAY_ERRCOUNT_UNCORRECTABLE gpu 0")

    def test_ras(self):
        sys.stdout.write("Running LevelZero RAS Test\n");

        #Query
        gpu_ras_reset_count_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_RESET_COUNT_CORRECTABLE gpu 0")
        gpu_ras_programming_errcount_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_PROGRAMMING_ERRCOUNT_CORRECTABLE gpu 0")
        gpu_ras_driver_errcount_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_DRIVER_ERRCOUNT_CORRECTABLE gpu 0")
        gpu_ras_compute_errcount_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_COMPUTE_ERRCOUNT_CORRECTABLE gpu 0")
        gpu_ras_noncompute_errcount_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT_CORRECTABLE gpu 0")
        gpu_ras_cache_errcount_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_CACHE_ERRCOUNT_CORRECTABLE gpu 0")
        gpu_ras_display_errcount_correctable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_DISPLAY_ERRCOUNT_CORRECTABLE gpu 0")
        gpu_ras_reset_count_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_RESET_COUNT_UNCORRECTABLE gpu 0")
        gpu_ras_programming_errcount_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_PROGRAMMING_ERRCOUNT_UNCORRECTABLE gpu 0")
        gpu_ras_driver_errcount_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_DRIVER_ERRCOUNT_UNCORRECTABLE gpu 0")
        gpu_ras_compute_errcount_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_COMPUTE_ERRCOUNT_UNCORRECTABLE gpu 0")
        gpu_ras_noncompute_errcount_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_NONCOMPUTE_ERRCOUNT_UNCORRECTABLE gpu 0")
        gpu_ras_cache_errcount_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_CACHE_ERRCOUNT_UNCORRECTABLE gpu 0")
        gpu_ras_display_errcount_uncorrectable = geopm_test_launcher.geopmread("LEVELZERO::GPU_CORE_RAS_DISPLAY_ERRCOUNT_UNCORRECTABLE gpu 0")
