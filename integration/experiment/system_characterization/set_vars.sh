...
# This script is sourced from sys_charac_platform_sweeps.sh and sys_charac_freq_sweeps.sh

export GEOPM_SOURCE=${SCRIPT_DIR}/../../../
...
BOARD_POWER_STEP=250
BOARD_MIN_POWER=1000 # lower the value, lower the power headroom for the components
BOARD_MAX_POWER=4000 # higher the value, more the power headroom for the components
