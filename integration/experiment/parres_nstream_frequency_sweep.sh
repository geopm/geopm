...
OUTPUT_DIR=${GEOPM_WORKDIR}/parres_nstream_100_freq_sweep

/home/slcoumer/geopm/integration/experiment/gpu_frequency_sweep/run_gpu_frequency_sweep_parres_nstream.py \
    --node-count=1 \
