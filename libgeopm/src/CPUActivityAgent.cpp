...
namespace geopm
{
    ...
    CPUActivityAgent::CPUActivityAgent(PlatformIO &plat_io,
        ...
        , m_core_batch_writes(0.0)
        , m_uncore_frequency_requests(0.0)
        , m_uncore_frequency_clamped(0.0)
        , m_resolved_f_uncore_efficient(0.0)
        , m_resolved_f_uncore_max(0.0)
        , m_resolved_f_core_efficient(0.0)
        , m_resolved_f_core_max(0.0)
        , m_freq_uncore_min(0.0)
        , m_freq_uncore_max(0.0)
        , m_freq_uncore_efficient(0.0)
        , m_freq_core_min(0.0)
        , m_freq_core_max(0.0)
        , m_freq_core_efficient(0.0)
