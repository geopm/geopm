...
namespace geopm
{
    class LevelZero
    {
        public:
            ...
            virtual double ras_reset_count_correctable(unsigned int l0_device_idx,
                                           int l0_domain, int l0_domain_idx) const = 0;
            ...
            virtual double ras_programming_errcount_correctable(unsigned int l0_device_idx,
                                                    int l0_domain, int l0_domain_idx) const = 0;
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Programming Error Count
            virtual double ras_driver_errcount_correctable(unsigned int l0_device_idx,
                                               int l0_domain, int l0_domain_idx) const = 0;
            ...
            virtual double ras_compute_errcount_correctable(unsigned int l0_device_idx,
                                                int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of correctable errors that have
            ...
            virtual double ras_noncompute_errcount_correctable(unsigned int l0_device_idx,
                                                   int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of correctable errors that have
            ...
            virtual double ras_cache_errcount_correctable(unsigned int l0_device_idx,
                                              int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of correctable errors that have
            ...
            virtual double ras_display_errcount_correctable(unsigned int l0_device_idx,
                                                int l0_domain, int l0_domain_idx) const = 0;
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Accelerator Engine Reset count
            virtual double ras_reset_count_uncorrectable(unsigned int l0_device_idx,
                                           int l0_domain, int l0_domain_idx) const = 0;
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Programming Error Count
            virtual double ras_programming_errcount_uncorrectable(unsigned int l0_device_idx,
                                                    int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of low level driver
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Programming Error Count
            virtual double ras_driver_errcount_uncorrectable(unsigned int l0_device_idx,
                                               int l0_domain, int l0_domain_idx) const = 0;
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Compute Error Count
            virtual double ras_compute_errcount_uncorrectable(unsigned int l0_device_idx,
                                                int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of uncorrectable errors that have
            /// occurred in the fixed-function accelerator hardware
            /// @param [in] l0_device_idx The index indicating a particular
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Non Compute Error Count
            virtual double ras_noncompute_errcount_uncorrectable(unsigned int l0_device_idx,
                                                   int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of uncorrectable errors that have
            /// occurred in caches (L1/L3/register file/shared local memory/sampler)
            /// @param [in] l0_device_idx The index indicating a particular
            ...
            /// @param [in] l0_domain The LevelZero domain type being targeted
            /// @return Cache Error Count
            virtual double ras_cache_errcount_uncorrectable(unsigned int l0_device_idx,
                                              int l0_domain, int l0_domain_idx) const = 0;
            /// @brief Get the LevelZero count of number of uncorrectable errors that have
            ///        occurred in the display.
            /// @param [in] l0_device_idx The index indicating a particular
