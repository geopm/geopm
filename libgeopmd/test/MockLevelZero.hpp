...
class MockLevelZero : public geopm::LevelZero
{
    public:
        ...
        MOCK_METHOD(int, ras_domain_count, (unsigned int, int),
                    (const, override));
        MOCK_METHOD(double, ras_reset_count_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_programming_errcount_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_driver_errcount_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_compute_errcount_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_noncompute_errcount_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_cache_errcount_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_display_errcount_correctable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_reset_count_uncorrectable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_programming_errcount_uncorrectable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_driver_errcount_uncorrectable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_compute_errcount_uncorrectable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_noncompute_errcount_uncorrectable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_cache_errcount_uncorrectable, (unsigned int, int, int),
                    (const, override));
        MOCK_METHOD(double, ras_display_errcount_uncorrectable, (unsigned int, int, int),
                    (const, override));
