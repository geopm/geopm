...
detailed code examples in multiple languages.  Please select one of the tabs for
your language of choice (e.g. bash, python, etc.) and this preference will be
...
For in-depth descriptions of these two parts of the GEOPM software see:
:doc:`service` or :doc:`runtime`.
