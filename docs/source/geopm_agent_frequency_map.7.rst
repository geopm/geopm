...
-----------------
  ...
  ``HASH_0``\ :
      ...
      policy values are stored in the double precision
      ...
      the hash of that string. See :ref:`Frequency Map Examples <frequency_map_examples>` section below for
      details.
