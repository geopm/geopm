...
\begin{figure} [H]
  \centering
  \includegraphics[clip, trim=5cm 8cm 5cm 8cm, width=0.5\textwidth]{leaf-figure}
...
\begin{figure} [H]
  \centering
  \includegraphics[clip, trim=5cm 8cm 5cm 8cm, width=0.5\textwidth]{tree-figure}
...
% Platform.hpp - also need control_domain(), bound()?
\begin{verbatim}
...
% RAPLPlatform.cpp - add other models?
\begin{verbatim}
...
% XeonPlatformImp.cpp; impl in Xeon base class
\begin{verbatim}
